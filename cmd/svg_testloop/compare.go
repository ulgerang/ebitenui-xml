...
// TestResult holds comparison result for one SVG test case.
...
func CompareImages(browserPath, ebitenPath string, cases []SVGTestCase) []TestResult {
...
func GenerateReport(results []TestResult, outPath string) error {
	...
	for _, r := range results {
		...
		rows += fmt.Sprintf(
			...
			statusClass, r.TC.ID, r.TC.Category, r.TC.Label, r.DiffPct, r.AvgDelta, statusText)
	}

	html := fmt.Sprintf(`<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>SVG TestLoop Report</title>
<style>
...
<h1>SVG TestLoop Comparison Report</h1>
<div class="summary">
...
<table>
<thead><tr><th>Test ID</th><th>Category</th><th>Label</th><th>Diff %%</th><th>Avg Delta</th><th>Status</th></tr></thead>
<tbody>
%s
</tbody></table>
